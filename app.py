...
# This runs once to set defaults.
...
# --- 4. HELPER FUNCTIONS (MATH, AI, PLOTTING) ---
# Defined here so they are available to the rest of the script.
...
# Save/Load
st.sidebar.markdown(f"""<div style="display: flex; align-items: center; margin-bottom: 10px;">{ICON_UPLOAD}<h2 style="display: inline; font-size: 1.5rem; margin-left: 5px;">Save & Load Analysis</h2></div>""", unsafe_allow_html=True)
with st.sidebar.expander("Open Controls", expanded=False):
    st.info("Workflow Continuity: Download inputs to resume later.")
...
c3.caption("Higher 'Products / Order' means users are building bigger baskets.")
