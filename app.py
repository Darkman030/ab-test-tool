...
def get_ai_analysis(api_key, hypothesis, metrics_dict, provider="OpenAI", conf_level="95%"):
    ...
    try:
        ...
        prompt = f"Analyze results. Config: {conf_level}. Hypothesis: {hypothesis}. Data: {metrics_dict}. Provide executive summary, trade-offs, and risk assessment."
...
# --- 5. AUTO-INSIGHTS GENERATOR (NO EMOJIS) ---
...
# --- 6. PLOTTING FUNCTIONS (DEFINED BEFORE USE) ---
